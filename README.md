...
- Push commits **at least once per week** (required for journal evidence)
- Only edit files inside your own `game_X/` folder
- Discuss any changes to `shared/` with the group first
- Use descriptive commit messages: `"Add pawn movement validation"` not `"update"`
